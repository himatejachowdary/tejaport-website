...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "AI-powered symptom analysis tool providing predictions and health insights based on user inputs. Built with modern UI design and deployed as a responsive web application.",
